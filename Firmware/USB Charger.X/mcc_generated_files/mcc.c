...
#pragma config DSWDTPS = DSWDTPS12    // Deep Sleep Watchdog Timer Postscale Select bits->1:8388608 (4.5 Minutes)
...
#pragma config LPCFG = 0    // Low power regulator control->Low voltage regulator controlled in sw by RETEN bit
...
{
    // DOZEN disabled; DOZE 1:8; CPDIV 1:1; RCDIV FRC/1; PLLEN enabled; ROI disabled; 
    CLKDIV = 0x3020;
